...
export default function Worksheet() {
  ...
  return (
    <div className="max-w-full w-full lg:px-20 lg:py-36 py-14 px-5 gap-28 bg-white">
      <div className="w-full flex flex-col gap-28">
        <div className="w-full flex lg:flex-row flex-col justify-between gap-10">
          <h2
            ref={headRef}
            className="lg:w-[40%] lg:text-5xl w-full text-left text-3xl font-normal font-sans text-black leading-[140%]"
          >
        ...
        <div className="w-full flex flex-col gap-36">
          ...
          {/* Case 2 */}
          <div className="w-full flex lg:flex-row flex-col gap-16 justify-between">
          ...
          {/* Case 3 */}
          <div className="w-full flex lg:flex-row-reverse flex-col-reverse gap-16 justify-between">
