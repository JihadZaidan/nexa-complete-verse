...
import { useSlideFromTop, useSlideFromRight } from "@/library/animations"
    ...
    return (
        <div className="max-w-full w-full bg-white lg:px-18 lg:pt-16 lg:pb-20 px-9 pt-5 pb-8">
            <div className="w-full justify-left items-left flex flex-col lg:gap-25 gap-16">
                <h1 ref={headRef} className="w-full text-left lg:text-7xl text-3xl font-normal font-sans text-black leading-[150%]">
                    Digital Diaries: <br />
