        ...
        <div className="max-w-full w-full lg:px-20 lg:py-16 md:px-14 md:py-10 px-5 pt-7 pb-3 bg-neutral-100">
            <div className="w-full flex flex-col justify-between lg:gap-30 gap-8">
                ...
                <Image
                    ...
                    src={cheepa}
                    alt="upper section"
                    className="lg:w-[33%] md:w-[33%] lg:absolute md:absolute lg:opacity-[100%] md:opacity-[100%] opacity-0 lg:top-[587.68px] lg:left-[930px] md:left-[500px] md:top-[450px] lg:visible md:invisible invisible"
                />
